...
namespace Deveel.Data {
    ...
    public abstract class MongoRepositoryTestSuite<TPerson> : RepositoryTestSuite<TPerson, ObjectId, MongoPersonRelationship>, IAsyncInitializer, IAsyncDisposable
        ...
        protected override async Task InitializeAsync(IRepository<TPerson, ObjectId> repository) {
